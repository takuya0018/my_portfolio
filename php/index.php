...
<html lang="ja">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="description" content="Takuya Kikutaのポートフォリオサイト">
        <meta name="keywords" content="菊田琢也,Takuya Kikuta,WEB制作,熊本,地域復興,農家,WEBデザイン">
    ...
    <main class="top_mainImg_wrap" id="topPage">
      ...
      <article id="content-inner-wrap">
          ...
          <ul class="service_item_list">
            <li class="service_items item_list01">
              ...
              <div class="icon_wrap note_wrap">
                <figure class="item_logo_wrap"><img src="./images/direction_logo.png" alt="ディレクション"></figure>
              </div>
            ...
            <li class="service_items item_list02">
              ...
              <div class="icon_wrap pencil_wrap">
                <figure class="item_logo_wrap"><img src="./images/design_logo.png" alt="デザイン"></figure>
              </div>
            ...
            <li class="service_items item_list03">
              ...
              <div class="icon_wrap dating_wrap">
                <figure class="item_logo_wrap"><img src="./images/coding_logo.png" alt="制作"></figure>
              </div>
        ...
        <div id="canvas-container">
          <canvas id="sineCanvas" width="1430" height="300"></canvas>
        </div>
